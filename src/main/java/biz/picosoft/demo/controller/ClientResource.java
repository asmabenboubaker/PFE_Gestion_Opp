...
import biz.picosoft.demo.service.ClientQueryService;
...
/**
 * REST controller for managing {@link biz.picosoft.demo.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    public ResponseEntity<ClientDTO> updateClient(
        ...
        ClientDTO result = clientService.update(clientDTO,id);
        return ResponseEntity
            .ok()
    ...
    @GetMapping("/clients/WithoutPages")
    public ResponseEntity<List<ClientDTO>> getAllClientsWithoutPages(
            ClientCriteria criteria,
            @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get Clients by criteria: {}", criteria);
