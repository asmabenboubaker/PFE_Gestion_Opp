...
public class BCOutputDTO  extends ObjectsDTO implements Serializable {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        BCOutputDTO that = (BCOutputDTO) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, montantTotal, dateCommande, description, statut, offre, projet);
    }
