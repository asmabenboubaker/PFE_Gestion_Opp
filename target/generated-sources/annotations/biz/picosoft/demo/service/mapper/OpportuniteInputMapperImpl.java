...
public class OpportuniteInputMapperImpl extends OpportuniteInputMapper {
    ...
    public Opportunite toEntity(OpportuniteInputDTO oppInputDTO) {
        ...
        opportunite.setNomDepartement( oppInputDTO.getNomDepartement() );
        opportunite.setSidDepartement( oppInputDTO.getSidDepartement() );
        ...
        Set<EtudeOpp> set1 = oppInputDTO.getEtudeOpps();
        if ( set1 != null ) {
    ...
    public OpportuniteInputDTO toDto(Opportunite opp) {
        ...
        if ( set != null ) {
            opportuniteInputDTO.setEtudeOpps( new HashSet<EtudeOpp>( set ) );
        }
        opportuniteInputDTO.setNomDepartement( opp.getNomDepartement() );
        opportuniteInputDTO.setSidDepartement( opp.getSidDepartement() );
        Set<Equipe> set1 = opp.getEquipes();
        if ( set1 != null ) {
            opportuniteInputDTO.setEquipes( new HashSet<Equipe>( set1 ) );
        }
